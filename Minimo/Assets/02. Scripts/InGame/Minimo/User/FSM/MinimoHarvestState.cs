...
public class MinimoHarvestState : State<MinimoObject>
{
    ...
    public MinimoHarvestState(MinimoObject owner) : base(owner)
    {
    ...
    public override void Execute()
    {
        if (_workTree.Tick() == NodeStatus.Failure)
        {
            ...
            OrderManager.Instance.FailHarvest();
        }
    }
