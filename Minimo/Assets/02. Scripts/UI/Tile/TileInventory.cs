...
public class TileInventory : Inventory<CustomTile>
{
    protected override void SetString()
    {
        ...
        _menuTogs[0].GetComponentInChildren<TextMeshProUGUI>().text = titleData.GetString("STR_STORTAGE_UI_FILTER_COMPONENT1_NAME");
        _menuTogs[1].GetComponentInChildren<TextMeshProUGUI>().text = titleData.GetString("STR_TILEMANAGE_TAB1_NAME");
